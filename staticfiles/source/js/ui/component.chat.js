...
!function($) {
    ...
    ChatApp.prototype.save = function() {
        ...
        if (chatText == "") {
            ...
            $('<li class="clearfix odd"><div class="chat-avatar"><img src="/static/images/users/avatar-1.jpg" alt="male"><i>' + chatTime + '</i></div><div class="conversation-text"><div class="ctext-wrap"><i>Dominic</i><p>' + chatText + '</p></div></div></li>').appendTo('.conversation-list');
            this.$chatInput.focus();
