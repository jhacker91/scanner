...
Hyper comes with multiple demos (skins). I.e. ``creative``, ``default``, ``material``, ``modern``, ``purple``, and ``saas``. 
...
In-built Layouts
-----------------
Hyper provides multiple choices when it comes to layouting. There are multiple layout choices available. 
...
-----------------------------------------------------------------------------
Hyper allows you to have customized left sidebar, overall layout width or right sidebar. 
